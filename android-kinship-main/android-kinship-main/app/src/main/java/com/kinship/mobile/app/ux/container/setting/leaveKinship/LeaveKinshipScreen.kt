...
@Preview
@Composable
fun LeaveKinshipScreen(
    navController: NavController = rememberNavController(),
    viewModel: LeaveKinshipViewModel = hiltViewModel()
) {
    ...
    AppScaffold(
        ...
        topAppBar = {
            TopBarComponent(
                header = stringResource(id = R.string.leave_your_kinship1),
        ...
        navBarData = AppNavBarData(
            ...
            navBar = {
                BottomButtonComponent(
                    text = "Leave $kinshipName", onClick = {
                        showDialog = true
                    },
        ...
        apiResultFlow?.let { it1 ->
            NetworkResultHandler(
                ...
                onSuccess = { apiResponse ->
                    apiResponse.data?.let { it2 -> it2.message.let { it3 -> Toasty.success(context, it3, Toast.LENGTH_SHORT, false).show() } }
                    showDialog = false
    ...
    if (showDialog) {
        DialogWithInputAndButton(
            ...
            title = stringResource(id = R.string.reason_leave_kinship),
...
@Composable
fun LeaveKinshipContent(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Row {
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.leaving_kinship_1),
                    fontSize = 14.sp,
                    color = Black,
                    fontFamily = OpenSans,
                ...
                Text(
                    text = stringResource(R.string.leaving_kinship_2),
                    fontSize = 12.sp,
                    color = Black,
                    fontFamily = OpenSans,
        ...
        Row(modifier = Modifier.padding(top = 30.dp)) {
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.leaving_kinship_3),
                    fontSize = 14.sp,
                    color = Black,
                    fontFamily = OpenSans,
                    fontWeight = FontWeight.W600
                ...
                Text(
                    text = stringResource(R.string.leaving_kinship_4),
                    fontSize = 12.sp,
                    color = Black,
                    fontFamily = OpenSans,
                    fontWeight = FontWeight.W400,
