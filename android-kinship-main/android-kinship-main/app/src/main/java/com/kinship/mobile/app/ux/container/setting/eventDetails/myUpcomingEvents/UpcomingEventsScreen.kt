...
package com.kinship.mobile.app.ux.container.setting.eventDetails.myUpcomingEvents
...
@Composable
fun UpcomingEventsScreen(uiState: EventDetailsUiState) {
...
fun UpcomingEventsContent(
    ...
    val showLoader by uiState.showUpComingLoader.collectAsStateWithLifecycle()
    if (showLoader) {
        CustomLoader()
    }
}
