...
fun OtpVerificationScreen(
    ...
    AppScaffold(
        ...
        OtpVerificationContent(modifier = Modifier, uiState)
            ...
            NetworkResultHandler(
                ...
                onSuccess = { apiResponse ->
                    Toasty.success(context,
                        stringResource(R.string.you_have_signed_up_successfully), Toast.LENGTH_SHORT, false).show()
    ...
    Column(
        ...
        Column {
            Row{
                ...
                Text(
                    text = AppUtils.formatTime(countdown),
                    fontWeight = FontWeight.W400,
                    fontFamily = OpenSans,
                    color = Black,
                    fontSize = 14.sp,
