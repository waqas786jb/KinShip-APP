...
data class ExploreCommunityUiState(
    ...
    val exploreCommunitiesList: StateFlow<List<MyCommunitiesResponse>> = MutableStateFlow(emptyList()),
    val onClickSearchCommunity:()->Unit={},
    val navigateToCommunityPost:(String,String)->Unit={_:String,_:String->},
    val exploreCommunityAPICall:()->Unit={},
)
